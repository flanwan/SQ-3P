...
void factoryreset() {
   ...
   EEPROM.write(1,3); //transposemode
   EEPROM.write(2,1); //noteoffmode
   EEPROM.write(3,30); //notelength
   EEPROM.write(4,1); //outchannel
   EEPROM.write(5,1); //inchannel
   EEPROM.write(6,3); //notethrumode
   EEPROM.write(7,1); //controlthrumode
   EEPROM.write(8,0); //programthrumode
   EEPROM.write(9,1); //bendthrumode
   EEPROM.write(10,0); //otherthrumode
   EEPROM.write(28,0); //maxOfftempoCV
   EEPROM.write(29,0); //maxOffCV1
   EEPROM.write(30,0); //maxOffCV2   
