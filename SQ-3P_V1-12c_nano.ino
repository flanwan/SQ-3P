...
void loop() {
  ...
  if (menu > 0 ) { //SETUP
    ...
    */
    ...
    maxmenu = 15; // MAXMENU DETERMINES HOW MANY MENU PAGES ARE AVAILABLE
    ...
    switch (menu) {
      /*PLAYMODE,Transpose,NoteOffMode,Notelength,OutChannel,InChannel,NoteThru,ControlThru,ProgrammThru,BendTHru,OtherChannelThru,TrimmPotis,FactoryReset,LoadSequence,SaveSequence,ClockSelect};
